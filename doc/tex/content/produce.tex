...
\newpar DCR graphs can form graphs with cycles, and therefore a mechanism for handling these needs to be implemented. This is done by using a trace of previously contacted events and handling when a cycle is detected.\todo{Hvor ser jeg det i pseudokoden?}
