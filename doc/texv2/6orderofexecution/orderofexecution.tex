...
\section{Order of Execution}
	...
	After having found the transitive closure of the graph, actions that are either not an between \texttt{Execution start} and \texttt{Execution finish} action types can be filtered away from the graph. One of these execution types should denote an entire execution.
