...
\section{Order of Execution}
	...
	This can be accomplished by collapsing actions that are part of an execution into a representation of a single execution and then removing possible redundant edges in the order of execution. 
...
%	\todo{Denne figur skal laves ud fra GasWorkflow.}
	...
	\todo[inline]{Fra her, skriv sektion om, og flyt evt. til analyse-del ...}
