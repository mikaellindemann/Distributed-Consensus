...
\section{Order of Execution}
	...
	\begin{figure}
		...
		\caption{The result of finding an execution using \textit{Collapse}. Note that executions that previously (in \autoref{fig:problem:trans}) were concurrent are now ordered.}
