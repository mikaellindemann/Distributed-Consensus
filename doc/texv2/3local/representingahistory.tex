...
\chapter{Representing a History}\label{chap:representing-a-history}
	...
	\end{enumerate}
	\newpar These are the properties of strict partial order and therefore this ordering is fitting for the problem at hand. To represent this type of order a directed acyclic graph can be used since it allows for the same properties. 
	%\begin{enumerate}
