...
\chapter{Representing a History}\label{chap:representing-a-history}
    ...
    \todo[inline]{Venter på Wind's input... \\Fiks Søren's kommentar: "I don't get this. What are you trying to show?" - Old comment, left here for you to agree/while Søren looks at the new definition.}
