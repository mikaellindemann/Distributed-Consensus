...
\chapter{Theory}\label{chap:theory}
	...
	\begin{definition}[DCR Graph]
		...
		\end{itemize}
		A DCR Graph with data is a tuple (E,l,R,Md,g,V) where V is a set of data variables, Md = (M,ev), (E,l,R,M) is a DCR Graph, ev is an evaluation function mapping data variables to values, and g is a (partial) relation guard mapping from (some of) the relations to boolean expressions over variables.\cite{6975351} \todo{måske begræns til p. 128"}
	\end{definition}
