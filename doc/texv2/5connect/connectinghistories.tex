...
\label{chap:connecting-histories}
	...
	Using the representation of history detailed in \autoref{chap:representing-a-history} it is possible to create a graph of happens-before relations.
