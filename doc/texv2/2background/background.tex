...
%	Furthermore DCR graphs specify several types of directed edges in the graph, which provide useful information for determining order of execution.
	...
	\newpar A DCR graphs is in \cite{hildebrandt2011declarative} defined as a tuple $(E, M, Act, $\condition$, $\response$, \pm, l)$ where
	\begin{itemize}
...
%	The implementation of a distributed system functioning as a DCR graph used in this project does not support the milestone relation.
	...
	\section{Distributed Systems}
        ...
        \newpar Consensus can also be defined as a value on which participants must agree, as well as a definition of what it means to agree on that value. We will use this definition of consensus in \autoref{chap:order-of-execution}.\todo[inline]{Til Søren: Er dette nok til at komme ud af det med consensus?}
