...
%	The implementation of a distributed system functioning as a DCR graph used in this project does not support the milestone relation.
	...
	\section{Distributed Systems}
		...
		\figuretodo{Man kunne godt tilføje en figur her, som på en eller anden måde viste seriel ækvivalens. Er det overflødigt?}
		...
		\caption{The strict partial order of $N$ ordered by divisibility resulting in a natural number.\todo[inline]{Måske skulle vi beskrive hvordan man læser pilen.}}
