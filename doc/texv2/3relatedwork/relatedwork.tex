...
\chapter{Theory}\label{chap:theory}
	...
	\section{Distributed Systems}
		...
		\subsection{History}
		It is often wanted to see a history of which events (\textit{actions}) has occured. In \cite{Lamport:1978:TCO:359545.359563}, Lamport describes the relation between events, and their place in time as an ordering of events. 
