...
\label{chap:consensusindcr}
	...
	This also introduces a special kind of cheating:
		...
		\begin{definition}
			\textbf{Inconsistent cheating} is the act of manipulation data in a way that is not adhering to the rules of the DCR graph
		\end{definition}
	...
	Until now we have examned inconsistent cheating, but malicious events are also able to cheat consistently:
	\begin{definition}
		\textbf{Consistent cheating} is the act of manipulation data in a way that is adhering to the rules of the DCR graph
	\end{definition}
