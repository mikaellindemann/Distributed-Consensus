...
\chapter{Validation of Histories}\label{chap:validation}
    ...
    \newpar
	\todo{Sørg for at inkluder dette i background - måske fjern cite?}
	...
	As argued in ,\todo{Refer to argumentation of collapse} concurrent executions only happen if the executed events are independent. In \cite{debois2015concurrency}, Debois et. al. conclude that any order of execution of independent events results in the same marking. Therefore any topological ordering of an order of execution is sufficient to simulate any ordering of concurrent events.
