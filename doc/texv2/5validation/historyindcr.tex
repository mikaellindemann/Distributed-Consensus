...
\chapter{Validation of Histories}\label{chap:validation}
	...
	\noindent Figure \ref{fig:validation:wait-for-complete-execution} shows a situation where $B$ is included by $A$ but executes before the other relation from $A$ is present in the history.
