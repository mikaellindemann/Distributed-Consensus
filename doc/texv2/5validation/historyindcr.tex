...
%	\newpar One could argue the implications of consistent cheating in sub-graphs such as those of case 1 and 2, since their these events have little consequences on the rest of the workflow state. Therefore these events can only exist in two states (before and after they are executed) and therefore not being able to handle these kinds of situations is not that big a flaw. The major problems are apparent in situation 6 and 7 where, for example, a company can own a sub-part of the graph with many events working together to create a falsified image of what has actually happened. 
	...
	\begin{table}
		...
		\begin{tabular}{lll}
			...
			\textit{Rule 1 (Only specified relations)}         & X          & -            \\
			\textit{Rule 2 (Only complete executions)}         & X          & -            \\
			\textit{Rule 3 (Executions only in valid states)}  & X          & -            \\
			\textit{Rule 4 (Only non disrupted executions)}    & X          & X            \\
			\textit{Rule 5 (Wait for complete execution)}      & X          & X            \\
			\textit{Rule 6 (Synchronous message exchange)}     & X          & X            \\
			\textit{Rule 7 (Total order of timestamps)}        & X          & X            \\
			\textit{Rule 8 (Message exchange timestamp order)} & X          & X           
		\end{tabular}
	...
	\begin{table}
		...
		\begin{tabularx}{\textwidth}{|X|X|X|X|}
			\hline\textbf{Consistent Cheating\-} & \textbf{Timestamp changes\-} & \textbf{Execution amt. of 1st event} & \textbf{Execution amt. of 2nd event} \\\hline
			\textit{Case 1} & No & No & N/A \\\hline
			\textit{Case 2} & Yes & Yes & No \\\hline
			\textit{Case 3} & Yes & No & Yes \\\hline
			\textit{Case 4} & Yes & Yes & Yes \\\hline
			\textit{Case 5} & No & No & No \\\hline
			\textit{Case 6} & No & No & No \\\hline
		\end{tabularx}
